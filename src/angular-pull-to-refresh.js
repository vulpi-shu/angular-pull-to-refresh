...
angular.module('mgcrea.pullToRefresh', [])
  ...
  .directive('pullToRefresh', ['$compile', '$timeout', '$q', 'pullToRefreshConfig', function($compile, $timeout, $q, pullToRefreshConfig) {
        ...
        return function postLink(scope, iElement, iAttrs) {
          ...
          var notIOS = function() {
            ...
            var _setContentPan = function() {
              ...
              iElement[0].style.transform = iElement[0].style.transform = 'translateY(' + pan.distance + 'px)';
            };
            ...
            var _panEnd = function(e) {
              ...
              e.preventDefault();
              iElement[0].style.transform = iElement[0].style.transform = '';
          ...
          iElement.bind('touchend', function(ev) {
            ...
            ptrElement.style.transitionDuration = 0;
            ...
            $q.when(scope.$eval(iAttrs.pullToRefresh))
              .then(function() {
                ...
                $timeout(function() {
                  ...
                  ptrElement.style.transitionDuration = '';
                  scope.status = 'pull';
